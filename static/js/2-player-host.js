...
(function()
{
    ...
    var update = function () {
        ...
        ball.update( player_2.paddle , player_1.paddle );
    };
    ...
    {
        this.paddle.move( tiltPlayer1 , 0 );
    };
    ...
    {
        this.paddle.move( tiltPlayer2 , 0 );
    };
    ...
    MotionController.prototype.update = function()
    {
        ...
        if( currentTilt.x )
        {
            ...
            // TODO : we'll need a p1 and p2 value system
    ...
    var updater = {
        ...
        showMessage: function(message) {
            ...
            var player = parseInt( message.player );
    ...
    var qr_code_p1 = new QRCode( "qrcode-p1" , {
        text: "http://192.168.0.157:8888/player-1" ,
        width: 128 ,
        height: 128 ,
        colorDark : "#000000" ,
        colorLight : "#ffffff" ,
    ...
    var qr_code_p2 = new QRCode( "qrcode-p2" , {
        text: "http://192.168.0.157:8888/player-2" ,
        width: 128 ,
        height: 128 ,
        colorDark : "#cc0000" ,
        colorLight : "#ffffff" ,
